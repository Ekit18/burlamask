...
//     const { data } = await $awsHost.get('image-aws/:selectedBrand/:selectedType');
//     return data;
// };

// export const deleteStatic = async (key: string): Promise<ApiStatusCode> => {
//     try {
//         const { data } = await $awsHost.delete(`image-aws/${key}`);
...
//     const { data } = await $awsHost.get('image-aws/part-brands');
//     return data;
// }
...
//     const { data } = await $awsHost.get(`image-aws/part-types-of-brand/${selectedBrand}`);
...
//     const { data } = await $awsHost.post(`image-aws/${staticType}/${partId}`, formData, {
//         headers: {
